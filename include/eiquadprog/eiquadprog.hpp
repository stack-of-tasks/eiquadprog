...
inline void compute_d(VectorXd& d, const MatrixXd& J, const VectorXd& np) { d = J.adjoint() * np; }
...
inline double solve_quadprog(MatrixXd& G, VectorXd& g0, const MatrixXd& CE, const VectorXd& ce0, const MatrixXd& CI,
 ...
 */
inline double solve_quadprog2(LLT<MatrixXd, Lower>& chol, double c1, VectorXd& g0, const MatrixXd& CE,
